        ...
        {PILLARS.map((pillar) => {
          ...
          return (
            ...
            >
              ...
              >
                <PillarIcon pillar={pillar.id} className="h-11 w-11 shrink-0" />
                ...
                <span className="flex items-center gap-2">
                  <span className="hidden rounded-full bg-green-pale px-3 py-1 text-xs font-bold text-ink/70 md:inline">
                    {pillar.items.length} 項訴求
                  </span>
                  <svg
                    viewBox="0 0 20 20"
              ...
              >
                <div className="overflow-hidden">
                  <div className="border-t border-ink/10 px-5 pt-5 pb-6 md:px-7">
                    {pillar.intro.split('\n').map((para) => (
                      <p key={para.slice(0, 12)} className="mt-2 text-[15px] leading-7 text-ink/75 first:mt-0">
                        {para}
                      </p>
                    ))}
